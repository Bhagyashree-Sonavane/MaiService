...
<body>
	...
	<h2 align="center">You must pay a advance for the booking this service(Only 100/- rupee )</h2>
	<div class="container">
		...
		<table border="1" class="table table-hover">
			<tbody>
				...
				<tr align="center">
					...
					<td><input  class="form-control" title="TXN_AMOUNT" tabindex="10"	type="text" name="TXN_AMOUNT"value="100" readonly>
					</td>
				</tr>
				<tr align="center">
