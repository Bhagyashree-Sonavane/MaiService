                                    ...
                                    <div class="widget-body">
                                        <div class="row">
                                            <div class="col-xl-8 d-flex flex-column justify-content-center align-items-center" >
                                                ...
                                                <h2><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo $pname; ?></u></b><br>
                                                <font color="black"><b>Period :</b> <?php echo $period; ?><br>
							...
							<!-- End Widget 16 -->
							 ...
							 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" >
                                <div class="widget widget-16 has-shadow" style="background-color:cornflowerblue">
                                    ...
                                    <div class="row">
                                            <div class="col-xl-8 d-flex flex-column justify-content-center align-items-center" >
                                                <div class="total-views" style="color:White"><b>Hire On Mai Service</b></div>    
                                        ...
                                        <div class="row">
                                            <div class="col-xl-8 d-flex flex-column justify-content-center align-items-center" >
                                                ...
                                                <div class="counter"> <i class="la la-rupee">
                                                <?php    if(isset($profit))
                                                             echo $profit.".00"; 
                                                         else
                                                            echo "0.00";
