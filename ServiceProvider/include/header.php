                ...
                <nav class="navbar fixed-top" style="background-color: blanchedalmond">         
                    ...
                    <div class="navbar-holder d-flex align-items-center align-middle justify-content-between" >
                        ...
                        <div class="navbar-header">
                           ...
                           <font color="black"><b> Mai Service</b></font>
                            <!-- Toggle Button -->
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                           ...
                           <?php if(isset($_SESSION['SP_id']) ) { ?>
                            ...
                            <li><a href="plans.php"><i class="la la-dollar"></i><span>Purchase Plans</span></a></li>

                            <li><a href="plan_status.php"><i class="la la-bolt"></i><span>Plan Status</span></a></li>
