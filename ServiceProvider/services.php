                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-11">
                                    ...
                                    <h2 class="page-header-title"></h2>
                                        ...
                                        <?php
                                         if(isset($_SESSION['SP_id']))
                                         {
                                          ...
                                          $sql ="SELECT COUNT(sp_id) FROM `tbl_service` WHERE sp_id=$id";
                                          $result=$connect->query($sql);
                                          while($row = $result->fetch_array())
                                          {
                                              $service_count=$row['COUNT(sp_id)']; 
                                          }
                                        //   echo "Service Count=$service_count";
                                        //   echo "plan_id=$plan_id";
                                        //   echo "service provider id=$id";
                                          
                                        if(!isset($plan_id))
                                              {
                                                  echo "<a href='plans.php'><font color='red' class='btn btn-primary'>First By the Plan</font></a>";
                                              } 
                                    if(isset($plan_id))
                                    {
                                        if($plan_id=='1' && $status=='Activate')
                                              {
                                                  if($service_count=='1')
                                                  { echo "<font color='red' class='btn btn-primary'>Only One Service you can Add on this plan</font>";
                                                  }if($service_count=='0'){ ?>
                                                  <a class="btn btn-gradient-01" href="#" data-toggle="modal" data-target="#modal-centered">Add New Service</a>
                                                  <?php }
                                              }
                                        if( ($plan_id=='2' || $plan_id=='3')&& $status=='Activate') {?>
                                               <a class="btn btn-gradient-01" href="#" data-toggle="modal" data-target="#modal-centered">Add New Service</a>
                                             <?php }
                                    }
                                ...
                                </div> <?php   if(isset($plan_id) && $status=='Waiting')
                                    {      
                                        echo "<h2 style='color:red' align='center'>Please wait for activate your account.(within 24 hrs)</h2>";
                                    }?>
                                    <?php   if(isset($plan_id) && $status=='Deactivate')
                                    {      
                                        echo "<h2 style='color:red' align='center'>Sorry,Your plan is expired </h2>";
                                    }?>
                                <!-- End Page Header -->
                                <div class="row">
                                        ...
                                        <div class="widget-image has-shadow">
                                            <div class="group-card">
                                                ...
                                                <div class="widget-body">
                                                    <div class="quick-actions">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a href="deleteservice.php?id=<?php echo $row['id']; ?>" class="dropdown-item"> 
                                                 ...
                                                 <?php   if($plan_id=='3' && $status=='Activate')
                                              { ?>
                                                    <a href="Card.php?id=<?php echo $row['id']; ?>" target="_blank" download> Get A Free Visiting Card</a>
                                              <?php } ?>
                                                </div>
                                                <!-- End Widget Body -->
                                            </div>
