            ...
            <div class="row flex-row h-100 bg-white">
                ...
                <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12 col-12 no-padding">
                    <div class="elisyam-bg background-03">
                        ...
                        <a href="User/index.php"class="btn btn-lg btn-gradient-01">Go To Back</a>

                            <h1>Join Our</h1><h1 style="color:palevioletred"> Mai Service</h1>
      ...
      function callfunction()
        {
            ...
            var textLength = textBox.value.length;
                ...
                {
                  document.getElementById('error2').innerHTML='Please entered more than 6 characters for password';
                }
