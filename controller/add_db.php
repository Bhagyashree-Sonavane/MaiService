        ...
        if(isset($_POST['btn_SPReg']))
        {
         ...
         if(isset($_POST['appoint']))
         {
            ...
            $name= mysqli_real_escape_string($connect,$_POST['name']);
             ...
             $sql="insert into tbl_appointment(service_id,userid,name,email,contact,address,a_date,time) 
                 values('$service_id','$userid','$name','$email','$contact','$address','$a_date','$time')";
             $result=mysqli_query($connect,$sql);
             if($result==true)
             {
