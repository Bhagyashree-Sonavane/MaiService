                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                            ...
                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="../assets/logo.png" alt="..." class="avatar rounded-circle"></a>
                                <ul aria-labelledby="user" class="user-size dropdown-menu">
                                    ...
                                    <center> <b>  Welcome <br> <font color="red" size="3">Bhagyashree</font><font color="black"> <i class="la la-smile-o la-2x"></i></font>
                                    </b></center></li>
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="Addplans.php"><i class="la la-ticket"></i><span>Plans</span></a></li>
                            ...
                            <li><a href="addprovider.php"><i class="ti ti-lock"></i><span>Permission Account</span></a></li>
                            ...
                            <li><a href="#dropdown-report" aria-expanded="false" data-toggle="collapse">
                                ...
                                <!-- <li><a href="service.php"><i class="ti ti-world"></i><span>Services</span></a></li> -->
                                        ...
                                        <li><a href="#dropdown-sp" aria-expanded="false" data-toggle="collapse">
                                            <i class="la la-user"></i><span>Service Provider</span></a>
                                            <ul id="dropdown-sp" class="collapse list-unstyled  pt-0">
                                                    <li><a href="rpt_activeuser.php">Active User</a></li>
                                                    <li><a href="rpt_reguser.php">Registered User</a></li>
                                            </ul>
                                        </li>
                                        
                                        <li><a href="#dropdown-pro" aria-expanded="false" data-toggle="collapse">
                                            <i class="la la-user"></i><span>Pro Service Provider</span></a>
                                            <ul id="dropdown-pro" class="collapse list-unstyled  pt-0">
                                                    <li><a href="rpt_spactive.php">Active User</a></li>
                                                    <li><a href="rpt_spdeactive.php">Deactive User</a></li>
                                            </ul>
                                        </li>

                                        <li><a href="#dropdown-plan" aria-expanded="false" data-toggle="collapse">
                                            <i class="la la-ticket"></i><span>Plan Wise</span></a>
                                            <ul id="dropdown-plan" class="collapse list-unstyled  pt-0">
                                                    <li><a href="rpt_starter.php">Starter</a></li>
                                                    <li><a href="rpt_basic.php">Basic</a></li>
                                                    <li><a href="rpt_premium.php">Premium</a></li>
                                            </ul>
                                        </li>
