        ...
        <div class="row">
            <div class="page-header">
                <!-- <div class="d-flex align-items-center"> -->
                    <h1 align="center">Graphical Month Wise Report of Earning</h1>
                <!-- </div> -->
            </div>
            </div>
            <!-- End Page Header -->
...
<?php
                            $sql="SELECT sum(amount) as Sum,MONTHNAME(start_date) as 'Month Name'
                            FROM tbl_plan_purchase WHERE  payment='TXN_SUCCESS' and YEAR(start_date) = YEAR(CURDATE())
