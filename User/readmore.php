   ...
   while($row = $result->fetch_array())
    ...
    <table id="sorting-table" class="table mb-0">
            <tbody>
                    ...
                    <tr>
                            <td colspan="4" align="center"><b>Do You Want To Book This Service Provider ?   </b><a href="services.php?id=<?php echo $row['service_id'];?>" class="btn btn-primary"> Book Service Provider </td>
                        </tr>
                    <?php } else { ?>
                    <tr>
                        <td colspan="3"  align="right"><b>Rate</b></td>
                        <td> <h4>Waiting For Service Provider Response.. <i class="fa fa-spinner"></i></h4></td>
                    <tr>
