...
<li class="dropdown"><a href="pro.php" class="">Join as a Pro</a></li>
...
<div class="sticky-cta profile-menu">
<div class="container-fluid">
<div class="sticky-flex">
<a href="#about" class="menu-item">About</a><span>·</span>
<a href="#reviews" class="menu-item">Reviews</a><span>·</span>
<a href="#photos" class="menu-item">Photos</a><span>·</span>
<a href="#video" class="menu-item">Videos</a><span>·</span>
<a href="#qa" class="menu-item">FAQs</a><span>·</span>
</div>
</div>
</div>
...
while($row = $result->fetch_array())
     {        
         ?>
<div class="kred"><i class="fa fa-trophy fa-fw"></i> <?php echo $row['COUNT(service_id)']; ?> hire on Mai Service</div>
     <?php } ?>
<div class="kred"><i class="fa fa-male fa-fw"></i> <span><?php echo $member; ?> employees </span></div>
<?php
$sql="select * from tbl_service_details where service_id=$id";
  ...
  while($row = $result->fetch_array())
       {        
           ?>
<div class="kred"><i class="fa fa-calendar-o fa-fw"></i> <span><?php echo $row['exp']; ?>years in business</span></div>
       <?php } ?>
</div>
</div>
...
<button class="btn btn-backlead get-started btn-block btn-lg" data-toggle="modal" data-target="#login">
    <i class="fa fa-dollar fa-fw"></i> Request estimate</button>

    <button class="btn btn-backlead get-started btn-block btn-lg" data-toggle="modal" data-target="#login">
    <i class="fa fa-calendar-o fa-fw"></i> Hired Service Provider</button>
...
<button class="btn btn-backlead get-started btn-block btn-lg" data-toggle="modal" data-target="#book">
    <i class="fa fa-calendar-o fa-fw"></i> Hired Service Provider</button>
...
<p><div><b>Hire when ready</b></div><div class="weight-300">Review the details, and securely hire on Mai Service</div></p>
<hr>
...
<div class="logo-footer"><h1> Mai Service</h1></div>
...
<ul>
<li><a href="howwork1.php">How it works</a></li>
<li><a href="../SP_Log.php">Signup</a></li>
<li><a href="proguide.php">Pro guide</a></li>
</ul>
</div>
<div class="footer-col">
...
<div class="container-fluid"><div class="term-links pull-right"><font color="black">&copy; <b>Bhagyashree</b></font> </div></div>
</div>
</footer>
</div>
<script type="text/javascript">
                ...
                <label class="radio-inline"><input type="radio" name="time" value="04.00pm-05.00pm">04.00 PM - 05.00 PM</label>
                 ...
                 <div class="form-group">
                      <b style="font-size:16px;color:red"><u>Note </u> :</b>
                       Appointment fee for <b> <?php echo $service_name; ?></b> is <b><?php echo $appointment_fee; ?></b> rs/- for Meeting.<br>
